// src/main/java/com/desafios/admision_mtn/outbox/OutboxRepository.java
...
public interface OutboxRepository extends JpaRepository<OutboxEntity, UUID> {
     ...
     */
    @Query("SELECT " +
           "AVG(EXTRACT(EPOCH FROM o.processedAt) - EXTRACT(EPOCH FROM o.createdAt)) as avgProcessingTimeSeconds, " +
           "MIN(EXTRACT(EPOCH FROM o.processedAt) - EXTRACT(EPOCH FROM o.createdAt)) as minProcessingTimeSeconds, " +
           "MAX(EXTRACT(EPOCH FROM o.processedAt) - EXTRACT(EPOCH FROM o.createdAt)) as maxProcessingTimeSeconds " +
