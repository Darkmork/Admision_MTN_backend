...
public class PistonExecutorService {
    ...
    private String createExecutableCode(String userCode, String input) {
        ...
        executableCode.append("    \n");
        executableCode.append("    # Detectar si el input es una llamada de función sin parámetros\n");
        executableCode.append("    if input_str.strip().endswith('()') and input_str.strip().startswith('").append(functionName).append("'):\n");
        executableCode.append("        # Es una llamada de función sin parámetros\n");
        executableCode.append("        result = ").append(functionName).append("()\n");
        executableCode.append("    else:\n");
